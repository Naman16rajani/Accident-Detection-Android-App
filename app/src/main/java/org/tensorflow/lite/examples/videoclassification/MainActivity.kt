...
//        private const val MODEL_LABEL_FILE = "kinetics600_label_map.txt"
        private const val MODEL_LABEL_FILE = "labels.txt"
        private const val MODEL_FPS = 50 // Ensure the input images are fed to the model at this fps.
        private const val MODEL_FPS_ERROR_RANGE = 0.1 // Acceptable error range in fps.
        private const val MAX_CAPTURE_FPS = 100
    }
    ...
    private fun createClassifier() {
        synchronized(lock) {
            ...
            Log.d("file path", modelFile)
            var modelFile1 ="model.tflite"
